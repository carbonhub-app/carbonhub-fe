  ...
  return (
    <div className="p-6">
      <div className="flex gap-6">
        ...
        <section className="w-[350px] bg-white dark:bg-slate-900 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-slate-800">
          <div>
            ...
            <div className="mb-4">
              <label className="block mb-1 font-medium text-gray-700 dark:text-gray-200" htmlFor="price">
                Limit Price ($){" "}
              ...
              <input
                ...
                min="0"
                step="0.01"
                className="w-full bg-gray-50 dark:bg-slate-800 border border-gray-300 dark:border-slate-700 rounded px-3 py-2 text-gray-900 dark:text-white"
                value={price}
          ...
          <div className="mt-6 pt-4 border-t border-gray-200 dark:border-slate-800">
            <div className="text-sm text-gray-600 dark:text-gray-300">
              ...
              <ul className="mt-2 space-y-1">
                {price && (
                  <li>
                    <span className="text-gray-700 dark:text-gray-200">Limit Price:</span> ${price}
                  </li>
                )}
                <li>
        ...
        <section className="flex-1 bg-white dark:bg-slate-900 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-slate-800">
